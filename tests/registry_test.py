...
#     dim, Dim, Tag, tag, tagged_dim, TaggedDim, Field, 
...
#     scape.registry.or_condition([])

# def test_or_condition1():
#     e = Equals(Field('x'), 2)
#     assert_equal( e , scape.registry.or_condition([e]))

# def test_or_condition_many():
#     cs = [Equals(Field('x'), 2), Equals('y', 3)]
#     assert_equal( cs , scape.registry.or_condition([cs]))
